	...
	<fieldset>
		...
		<table>
				...
				<td>
					<select name="course_id" id="course_id">
						...
						<?php foreach ($courses as $course):?>
							...
							<?php if ($course->id ==set_value('course_id',$student->course_id)): ?>
			...
			<tr>
				...
				<td>
					<input type="text" name="batch" value="<?php echo set_value('batch',$student->batch); ?>" id="batch_string" readonly>
